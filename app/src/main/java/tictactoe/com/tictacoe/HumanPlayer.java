...
public class HumanPlayer {
    ...
    public void makeMove(Game g,AIPlayer aiPlayer,int moveIndex,boolean turn){
        g.displayBoard();
        /*do{
...
*/
        ...
        if(reward != 0){
            AIActivity.qTable.updateQtable(aiPlayer.getCurrentState(),aiPlayer.getMoveIndex(),reward,"human");
        }
    }
